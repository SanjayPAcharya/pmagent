...
### - [x] A2 — 🤖 Prompt tightening per endpoint (M) ✅ DONE 2026-07-11 (few-shot measured & dropped; temp/maxTokens + directives kept; PROMPT_VERSION=2; api 107→109)
...
### - [x] B3 — 🤖 Draft-preview upgrade: editable + regenerate + per-bullet AC (M) ✅ DONE 2026-07-12 (web 48→54; browser-verified: pristine regenerate silent, dirty regenerate confirms + keeps edits on dismiss, created ticket = edited title with unchecked AC dropped)
