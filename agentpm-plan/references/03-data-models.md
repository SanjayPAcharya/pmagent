...
model User {
  ...
  name          String
  avatarUrl     String?
  githubId      String?  @unique // set from the GitHub APP connection in Phase 5, NOT from login
  githubLogin   String?
