...
| 3.7.3 | [phase-3.7.3-archive-restore.md](phases/phase-3.7.3-archive-restore.md) | Dedicated Archived views + restore — archived-tickets page per project, and project archiving (soft-delete + restore) with a per-org Archived projects page |
| 3.8.4 | [phase-3.8.4-beta-polish.md](phases/phase-3.8.4-beta-polish.md) | Beta-feedback polish — first external beta test (19 findings) triaged: drawer-in-place on Timeline, milestone discoverability, dependency visibility (owner O2), Blocked DnD, ad-hoc creation context, honest readiness labels, sprint-page layout + no-drag add, sprint chips on Board, label "+N"; Milestones v2 + DEC-1/2 follow |
