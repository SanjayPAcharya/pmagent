...
|---|---|---|---|
| 2026-06-25 | P2.6 | **Browser verification (Slices 4–6) in Chrome:** ✅ G2 theme `t` (light→dark), G2 accent (green preset → `--primary` recolor + persist + Reset), C2 AC checkboxes (1/3→2/3 toggle persisted), F2 drag EMPL-5 → Sprint 1 (2→3 tickets), F1 burndown (ideal+actual on completed sprints); no WS console errors. **Deferred (need 2nd user / mobile / specific data):** E1, B1, E3, B3, B5, H2 — build/test-verified. | — |
